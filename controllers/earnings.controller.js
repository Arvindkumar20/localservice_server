...
export const getEarningsOverview = async (req, res) => {
  try {
    ...
    if (userRole === "professional") {
      ...
      matchCondition = { paymentStatus: "paid" };
    } else {
    ...
    const [totalEarnings, pendingEarnings, withdrawnEarnings, monthlyEarnings, stats] = await Promise.all([
...
export const getEarningsSummary = async (req, res) => {
  try {
    ...
    const [weeklyEarnings, monthlyEarnings, yearlyEarnings, growth] = await Promise.all([
      Booking.aggregate([
